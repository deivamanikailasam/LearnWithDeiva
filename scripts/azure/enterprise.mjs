  ...
  stages: [
    {
      ...
      summary: 'Strategy, governance, platform and enablement for delivering Azure workloads at enterprise scale.',
      tag: 'enterprise-delivery',
      nodes: [
        {
          id: 'enterprise-cloud-strategy',
          title: 'Enterprise Cloud Strategy & Operating Model',
          summary: 'Cloud strategy, operating model and cloud center of excellence on Azure.',
          level: 'advanced',
          children: [
            ...
            { id: 'caf-alignment', title: 'Cloud Adoption Framework Alignment' },
          ],
        },
        {
          id: 'discovery-requirements',
          title: 'Discovery & Requirements Engineering',
          summary: 'Workload discovery, business case and requirements engineering on Azure.',
          level: 'intermediate',
          children: [
        ...
        },
        {
          ...
          summary: 'Architecture decisions, design reviews and reference blueprints on Azure.',
          level: 'advanced',
          children: [
        ...
        },
        {
          ...
          summary: 'Coding, IaC and naming standards, review process, quality gates.',
          level: 'intermediate',
          children: [
            { id: 'iac-coding-standards', title: 'IaC & Coding Standards' },
            { id: 'azure-naming-conventions', title: 'Azure Naming & Tagging Conventions' },
        ...
        },
        {
          ...
          summary: 'Internal developer platform, golden paths and shared modules for Azure teams.',
          level: 'advanced',
          children: [
            ...
            { id: 'shared-iac-modules', title: 'Shared IaC / Bicep Modules' },
        ...
        },
        {
          ...
          summary: 'Sourcing SaaS, partners and Azure Marketplace offerings through enterprise procurement.',
          level: 'advanced',
          children: [
            { id: 'vendor-due-diligence', title: 'Vendor Due Diligence' },
            { id: 'azure-marketplace-governance', title: 'Azure Marketplace Governance' },
            { id: 'build-vs-buy', title: 'Build vs Buy vs Partner Analysis' },
            { id: 'enterprise-agreement-management', title: 'Microsoft EA / MCA Management' },
        ...
        },
        {
          ...
          summary: 'Data classification, residency, stewardship and master data on Azure.',
          level: 'advanced',
          children: [
        ...
        },
        {
          ...
          summary: 'Risk registers, audit readiness and certification programs for Azure workloads.',
          level: 'advanced',
          children: [
            ...
            { id: 'pci-hipaa-program', title: 'PCI-DSS / HIPAA Program on Azure' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 'commitments-discounts', title: 'Reservations, Savings Plans, Hybrid Benefit' },
        ...
        },
        {
          ...
          summary: 'Intake, prioritization and portfolio governance for Azure initiatives.',
          level: 'intermediate',
          children: [
    ...
    },
    {
      ...
      summary: 'End-to-end delivery lifecycle for production-grade Azure workloads.',
      tag: 'production-lifecycle',
      nodes: [
        {
          id: 'requirements-design-phase',
          title: 'Requirements & Design Phase',
          summary: 'Discovery, requirements, design and sign-off for new Azure workloads.',
          level: 'intermediate',
          children: [
        ...
        },
        {
          ...
          level: 'intermediate',
          children: [
            { id: 'test-strategy-pyramid', title: 'Test Strategy & Pyramid for Azure Workloads' },
            { id: 'iac-testing-program', title: 'IaC / Bicep Testing Program' },
        ...
        },
        {
          ...
          level: 'advanced',
          children: [
            { id: 'cicd-pipeline-design', title: 'CI/CD Pipeline Design on Azure' },
        ...
        },
        {
          ...
          summary: 'SLOs, error budgets, on-call programs and resilience for Azure workloads.',
          level: 'advanced',
          children: [
            { id: 'sli-slo-sla-design', title: 'SLI/SLO/SLA Design for Azure Services' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 'golden-signals', title: 'Golden Signals for Azure Workloads' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 'waf-review-cadence', title: 'Azure Well-Architected Review Cadence' },
          ],
        },
      ],
    },
